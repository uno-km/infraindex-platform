...
class TestLLMClient:
    ...
    async def test_generate_briefing_fallback_on_error(self):
        ...
        from apps.api.core.ai_service import generate_daily_news_briefing, _get_mock_briefing
    ...
    def test_mock_briefing_contains_date(self):
        ...
        from apps.api.core.ai_service import _get_mock_briefing
        date_str = "2026-07-24"
    ...
    def test_mock_analysis_is_english(self):
        ...
        from apps.api.core.ai_service import _get_mock_analysis

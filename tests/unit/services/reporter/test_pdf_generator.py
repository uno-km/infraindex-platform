...
class TestPDFReporter:
    ...
    def test_reports_dir_created_on_import(self):
        ...
        import os
        from apps.services.reporter import pdf_generator
    ...
    def test_jinja_env_configured(self):
        ...
        from apps.services.reporter.pdf_generator import jinja_env
    ...
    async def test_fetch_market_data_returns_list(self):
        ...
        reporter = PDFReporter()
        with patch("apps.services.reporter.pdf_generator.async_session_factory", None):
    ...
    async def test_fetch_market_data_with_mock_db(self):
        ...
        reporter = PDFReporter()
        with patch("apps.services.reporter.pdf_generator.async_session_factory", mock_factory):
            result = await reporter._fetch_market_data()
    ...
    async def test_generate_report_with_playwright_mock(self):
        ...
        with patch("apps.services.reporter.pdf_generator.async_playwright", mock_async_playwright), \
             patch("apps.services.reporter.pdf_generator.async_session_factory", None):
            try:

import pytest
from apps.server.core import limiter

"""
===============================================================================
[테스트 명세서]
- 생성일: 2026-07-23
- 모듈명: tests/unit/domains/infrastructure/COR-92b9d69c_limiter_test.py
- Task ID: 92b9d69c
- 도메인: INFRASTRUCTURE
...
2. 테스트 기능 (What):
   - 해당 모듈(COR-92b9d69c_limiter_test.py)에 종속된 의존성 객체(Mock) 생성 및 동작 시뮬레이션.

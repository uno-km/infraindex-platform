...
from shared.models.storage import StoragePriceHistory
...
async def get_candlestick(
    ...
    if not rows:
        ...
        from apps.server.core.data_service import DataService
...
async def sync_global_storage_prices(
    ...
    from apps.batch.services.market.crawler_storage_global import GlobalStorageCrawler

...
[테스트 명세서]
- 생성일: 2026-07-23
- 모듈명: apps/web/tests/domains/crawler/UI-92b9d69c_EnterpriseDashboard.test.tsx
- Task ID: 92b9d69c
- 도메인: CRAWLER
...
2. 테스트 기능 (What):
   - 해당 모듈(UI-92b9d69c_EnterpriseDashboard.test.tsx)에 종속된 의존성 객체(Mock) 생성 및 동작 시뮬레이션.

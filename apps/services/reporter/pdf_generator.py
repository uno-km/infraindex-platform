...
from apps.api.core.database import AsyncSessionLocal as async_session_factory
from sqlalchemy import select
from apps.api.models.reporter import DailyReport
from apps.api.models.market import MarketProduct, MarketPriceObservation
    ...
    async def _fetch_market_data(self):
        ...
        async with async_session_factory() as session:
            ...
            for p in products:
                ...
                from apps.api.models.market import MarketListing
                obs_stmt = (
